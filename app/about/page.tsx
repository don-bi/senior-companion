            ...
            <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 ">
                    <div className="bg-[#d3ecd3ff]">
                        <AppearingBlock>
                            <div className="xl:pt-32 py-10 flex flex-col items-center">
                    ...
                    <div className={`bg-[#deefe2] min-h-full`}>
                        <AppearingBlock>
