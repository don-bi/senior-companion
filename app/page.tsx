        ...
        <div className="flex-col items-centermd:py-10 overflow-visible">
          ...
          <div className="bg-[#d3ecd3ff]">
            ...
            <div className="flex flex-col justify-center items-center text-center gap-5 px-[7.5%] py-14 w-full">
                ...
                <div className="text-2xl leading-8 tracking-wide text-center">Our journey is continually propelled by a simple and single idea: to bridge the gaps between generations and bring companionship, joy and understanding to our older adults.</div>
                <div className="flex relative gap-10 mt-6 w-full">
                  ...
                  <div className="text-xl leading-8 tracking-wide text-left">Recognizing the general lack and need for intergenerational interactions, we aspire to connect young adult students with older adults. Primarily, we work by establishing and mediating relationships between interested individuals from partner student volunteer associations and senior centers.
                  </div>
                </div >
            
                <div className="flex relative gap-10 mt-6 w-full">
                  <div className="text-xl leading-8 tracking-wide text-right">We are a community. A community that values the wisdom of older adults and the energy of our youth, working together to further a world where everyone feels heard, valued, and included. Join us as we continue to grow, one conversation at a time.
                  </div>
          ...
          {/* statistics section */}
          <div className={`flex flex-col gap-12 items-center px-[7.5%] py-10 bg-[#e9f2ef] relative`}>
